...
import utils
from model import get_pretrained_model_params, build_model
...
class EvalCkptDriver(object):
    ...
    def __init__(self, model_name='efficientnet-b0', batch_size=1):
        ...
        self.block_args, self.global_params = get_pretrained_model_params(model_name)
        self.image_size = self.global_params.image_size
